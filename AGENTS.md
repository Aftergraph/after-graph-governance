# after-graph-governance — Agent Execution Contract

<!-- Generated 2026-09-10 from REPOSITORY_INVENTORY.json, CI_COMMAND_INVENTORY.json, CI_RESULTS.json and a
     live probe of branch main at HEAD d44ff3ba9bf8da7b3fe80b4067becd263ff1c42b. Revision 1.
     NOTE: the workspace inventory recorded main at 20257c0; this file was generated
     from the live checkout (main at d44ff3ba9bf8da7b3fe80b4067becd263ff1c42b). Re-verify against your SHA.
     Regenerate the command blocks; hand-edit only the Ratchet section. -->

## Project

  Name        after-graph-governance
  Role        Governance source of truth — contracts, schemas, terminology
  Purpose     Canonical cross-repository contracts, architecture, terminology, exact-head state and evidence boundaries for the Aftergraph ecosystem.
...
## Local conventions (verified present on disk)
  ...
  VERIFY:    bash scripts/org-state-verify.sh
  ...
  Probes
  - pytest files: ./scripts/test_golden_mission_skeleton_v0_1.py, ./scripts/test_governance_exact_head_truth.py, ./scripts/test_verify_brand_assets.py, ./scripts/test_governance_ci_truth_reducer.py
  - verifier scripts: scripts/org-state-verify.sh, scripts/verify_brand_assets.py, scripts/verify_exact_head_truth.py
